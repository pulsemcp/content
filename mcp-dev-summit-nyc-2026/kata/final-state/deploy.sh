...
# Step 3: Forward environment variables needed by the app
echo "==> Setting environment variables on the droplet..."
ssh $SSH_OPTS ${REMOTE_USER}@${DROPLET_IP} bash -c "cat > ${APP_DIR}/.env" <<ENVFILE
SLACK_BOT_TOKEN=${SLACK_BOT_TOKEN:-}
SLACK_CHANNEL=${SLACK_CHANNEL:-#linear-clone-notifications}
ENVFILE
