...
const PRIORITY_OPTIONS: { value: Issue['priority']; label: string; color: string }[] = [
  { value: 'none', label: 'No priority', color: 'var(--text-muted)' },
  { value: 'p0', label: 'P0', color: 'var(--priority-p0)' },
  { value: 'p1', label: 'P1', color: 'var(--priority-p1)' },
  { value: 'p2', label: 'P2', color: 'var(--priority-p2)' },
  { value: 'p3', label: 'P3', color: 'var(--priority-p3)' },
];
              ...
              {showPriorityDropdown && (
                <div className="property-dropdown">
                  {PRIORITY_OPTIONS.map(opt => (
                    ...
                    >
                      {opt.value !== 'none' && <span className="priority-dot" style={{ background: opt.color }} />}
                      {opt.label}
                    </button>
                  ))}
                </div>
