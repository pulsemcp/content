...
This directory contains the completed state of the Linear clone app after all 5 kata milestones.
...
This is a reference snapshot. Use it to:
- See what the end result looks like before starting the exercises
- Compare your work against the completed version
- Understand the full architecture after all milestones are done
